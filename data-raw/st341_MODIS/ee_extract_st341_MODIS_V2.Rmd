...
```{r}
bands <- c("sur_refl_b01", "sur_refl_b02", "sur_refl_b03", "sur_refl_b06")
bands_new <- c("red", "nir", "blue", "SWIR2")

col <- ee$ImageCollection$Dataset$MODIS_061_MOD09GA$
...
## 1. vegetation index
points = sp
prefix = "st341_MOD09GA_2000-2023_"

# 提取LAI数据
ee_extract2(col, points, via = "drive", lazy = TRUE, prefix = prefix)
```
...
foreach(i = 1:25, icount()) %do% {
  ...
  prefix = sprintf("st341_LAI_2000-2023_group%02d_", i)
  print(prefix)
...
extract_EmissAlbedo <- function(sp, subfix="") {
  ...
  ee_extract2(col, sp,
    via = "drive", lazy = TRUE,
    outfile = glue("st341_Albedo_8D_V061_2000-2023{subfix}.csv")
  )
  ...
  ee_extract2(col, sp,
    ...
    outfile = glue("st341_Emiss_8D_v061_2000-2023{subfix}.csv")
  )
}
...
ee_extract2(col,
  sp_5,
  via = "drive", lazy = TRUE,
  prefix = "st341_LC-win5_2000-2023_"
)
```
